...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 19 14:39:41 2017
...
subject_list = ['2017062801', '2017070601']                      # list of subject identifiers
session_list = ['block1', 'block2','block3','block4','block5']              # list of session identifiers
...
# SelectFiles
templates = {'func': 'data/{subject_id}/{session_id}_bold.nii'}
...
preproc.connect([(infosource, selectfiles, [('subject_id', 'subject_id'),
                 ...
                 (selectfiles, sliceTiming, [('func', 'in_files')]),
