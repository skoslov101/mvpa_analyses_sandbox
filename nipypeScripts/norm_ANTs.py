...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 27 15:14:32 2017

@author: srk482-admin
This script will do normalization to the MNI with ANTs and then 2nd level analysis.

Taken from nipype beginner's guide tutorial
"""
...
working_dir = 'workingdir_2ndLvl'   # name of 2nd-level working dir
...
#### Establish input and output streams - Needs Editing
...
normflow.run('MultiProc', plugin_args={'n_procs': 2})
